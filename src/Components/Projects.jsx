...
const Projects = () => {
  ...
  return (
    <div name="projects" className="w-screen py-10">
        ...
        >
          <swiper-slide>
            <div className="h-[560px] border-[2px] rounded-2xl pb-5 bg-[#E7E7E7]">
              ...
              <div className="pt-2 text-center text-[20px] font-bold">My Buddy</div>
          ...
          <swiper-slide>
            <div className="h-[560px] border-[2px] rounded-2xl pb-5 bg-[#e7e7e7]">
              ...
              <div className="pt-2 text-center text-[20px] font-bold">Youtube Clone</div>
          ...
          <swiper-slide>
            <div className="h-[560px] border-[2px] rounded-2xl pb-5 bg-[#e7e7e7]">
              ...
              <div className="pt-2 text-center text-[20px] font-bold">Chat App</div>
              <div className="mt-2 text-center">
          ...
          <swiper-slide>
            <div className="h-[560px] border-[2px] rounded-2xl pb-5 bg-[#e7e7e7]">
              ...
              <div className="pt-2 text-center text-[20px] font-bold">Sorting Visualizer</div>
              <div className="mt-2 text-center">
                A visualization tool that helps in visualizing how various sorting
                algorithms like merge sort ,quick sort ,count sort etc works.
              </div>
              <div className="mt-4 flex gap-[8px] text-[14px] lg:text-[16px] md:gap-[10px] flex-wrap justify-center ">
                <div className="techButton overflow-y-hidden bg-[#E7E7E7]">
                  <div className="px-[10px] hover:translate-y-[-100%] duration-500  h-[40px]  font-semibold rounded-sm">
